...
$configurationData = Settings_CTWhatsAppBusiness_Record_Model::getUserConfigurationAllDataWithId($whatsappuseid);
...
if($groupMember == 1){
	...
	$response = CTWhatsAppBusiness_WhatsappChat_View::callCURL($url, $postfields, $auth_token);
