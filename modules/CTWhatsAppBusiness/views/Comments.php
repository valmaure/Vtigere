...
class CTWhatsAppBusiness_Comments_View extends Vtiger_IndexAjax_View {
	...
	function saveComments(Vtiger_Request $request) {
		...
		$getWhatsAppRecords = CTWhatsAppBusiness_Record_Model::getWhatsAppRecordQuery($startdate, $enddate);
