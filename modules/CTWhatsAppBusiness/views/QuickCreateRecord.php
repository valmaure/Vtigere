...
class CTWhatsAppBusiness_QuickCreateRecord_View extends Vtiger_IndexAjax_View {
	...
	function editRecord(Vtiger_Request $request){
		...
		$getModuleFields = CTWhatsAppBusiness_Record_Model::getModulefields($tabid, $sourceModuleName, $moduleRecordId);
	...
	function saveRecord(Vtiger_Request $request){
	    ...
	    $query = "UPDATE vtiger_whatsappbusinesslog SET whatsapplog_displayname = ? WHERE whatsapplog_contactid = ?";
	...
	function assignRecordPopup(Vtiger_Request $request){
		...
		$tabid = getTabid($sourceModuleName);
		$whatsappModuleFieldsData = CTWhatsAppBusiness_Record_Model::getWhatsappAllowModuleFields($sourceModuleName);
		...
		$whatsappModules = Settings_CTWhatsAppBusiness_Record_Model::getAllowModules();
	...
	function saveAssignRecord(Vtiger_Request $request){
		CTWhatsAppBusiness_Record_Model::assignAllMessage($request);
	}
