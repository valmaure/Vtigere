...
require_once('modules/CTWhatsAppBusiness/CTWhatsAppBusiness.php');

class SendWhatsAppMsgBusiness extends VTTask {
	...
	public function doTask($entity){
		...
		if(!empty($tonumbers)){
			...
			$this->smsNotifierId = CTWhatsAppBusiness::sendsms(strip_tags($content), $tonumbers, $current_user->id, $relatedid, $sendMessagewpnumber);
		}
		$util->revertUser();
