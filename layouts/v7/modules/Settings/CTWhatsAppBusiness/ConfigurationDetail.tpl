			...
			<div class="clearfix">
				...
				<div class="pull-right">
					{if $SELECTEDUSERID neq ''}
						<span><a href="https://kb.crmtiger.com/article-categories/whatsapp-integration-for-vtiger/" target="_blank" title="{vtranslate('LBL_HELP', $QUALIFIED_MODULE)}"><img src="layouts/v7/modules/Settings/CTWhatsAppBusiness/images/help.png" style="width: 26px;"></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
