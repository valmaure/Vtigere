...
<div id="sendWhatsappSmsContainer" class='modal-xs modal-dialog'>
    ...
    <div class = "modal-content" style="overflow-y: scroll;height: 500px;overflow-x: hidden;">
		<table class="table editview-table no-border">
			<tbody>
				...
				<tr class="">
					<td>{vtranslate('App Id', $MODULE)} <a href="https://kb.crmtiger.com/knowledge-base/install-whatsapp-business-vtiger-7x#wtsp_businss_account_setup" target="_blank"><i class="fa fa-question-circle" aria-hidden="true" style="cursor: pointer;"></i></a></td>
					<td>
				...
				<tr class="">
					<td>{vtranslate('Whatsapp Business Account Id', $MODULE)} <a href="https://kb.crmtiger.com/knowledge-base/install-whatsapp-business-vtiger-7x#wtsp_businss_account_setup" target="_blank"><i class="fa fa-question-circle" aria-hidden="true" style="cursor: pointer;"></i></a></td>
					<td>
				...
				<tr class="">
					<td>{vtranslate('User Access Token', $MODULE)} <a href="https://kb.crmtiger.com/knowledge-base/install-whatsapp-business-vtiger-7x#wtsp_businss_account_setup" target="_blank"><i class="fa fa-question-circle" aria-hidden="true" style="cursor: pointer;"></i></a></td>
					<td>
				...
				<tr class="">
					<td>{vtranslate('WhatsApp No', $MODULE)} <a href="https://kb.crmtiger.com/knowledge-base/install-whatsapp-business-vtiger-7x#wtsp_businss_account_setup" target="_blank"><i class="fa fa-question-circle" aria-hidden="true" style="cursor: pointer;"></i></a></td>
					<td>
				...
				<tr class="">
					<td>{vtranslate('CUSTOMFIELD2', $MODULE)} <a href="https://kb.crmtiger.com/knowledge-base/install-whatsapp-business-vtiger-7x#wtsp_businss_account_setup" target="_blank"><i class="fa fa-question-circle" aria-hidden="true" style="cursor: pointer;"></i></a></td>
					<td>
