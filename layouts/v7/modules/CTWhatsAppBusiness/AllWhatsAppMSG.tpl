			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="dropdown">
						...
						<ul class="dropdown-menu whatsapMenus whatsappb" role="menu" aria-labelledby="dropdownMenu1" style="width:340px;">
							<li class="hide">
								<a href="#">
							...
							<li>
								<a href="index.php?module=WhatsAppBusinessTemplates&view=List">
									<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_templates.png" title="{vtranslate('WhatsAppBusinessTemplates', 'WhatsAppBusinessTemplates')}"/>
									{vtranslate('WhatsAppBusinessTemplates', 'WhatsAppBusinessTemplates')}</p>
								</a>
							</li>
							<li>
							...
							<li>
								<a href="index.php?module=WhatsAppBusinessLog&view=List">
						...
						<div class="defaultText">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 padNone hide messageBlock">
								...
								<div class="conversationDiv yesRecordData">
									...
									<div>
										<div>
											<div class="firstMessageText hide" style="width: 100%;border: 1px solid lightgray;border-radius: 6px; height: 80px; display: flex;">
												<span class="sendTemplates" id="sendFirstTemplatesMessage" style="float: left;margin-left: 12px;cursor: pointer;">
													&nbsp;&nbsp;&nbsp;&nbsp;<p title=""> <span style="color:#3366CC">{ucfirst(vtranslate('LBL_CLICK_HERE', $MODULENAME))}</span> &nbsp;{vtranslate('SELECT_TEMPLATES', $MODULENAME)}</p>
												</span>
												&nbsp;&nbsp;
												<a href="https://kb.crmtiger.com/knowledge-base/how-to-use-whatsapp-business-integration-for-vtiger-7x/#whatsAppbusinesstemplate" target="_blank" title="Help"><img src="layouts/v7/modules/Settings/CTWhatsAppBusiness/images/help.png" style="width: 14px; padding-top: 16px;padding-right: 2px;"></a>
											</div>
											<div class="ipt-div text-wrapper">
												<div class="ipt-msg-div searchForm conversation-compose ipt-div text-wrapper whatsappb" data-emojiarea data-type="unicode" data-global-picker="false">
													<input type="hidden" id="replyMessageId" value="">
													<input type="hidden" id="replymessageText" value="">
													<span aria-hidden="true" id="removeWhatsAppTemplate" class="fa fa-close closeReplybutton hide" style="right: 48px;cursor: pointer;"></span>
												...
												<div class="icons-wrapper">
													...
													<div class="ipt-div-num whatsappb">
														{if $WHATSAPPUSERMANAGEMENT neq 'singleWhatsapp'}
