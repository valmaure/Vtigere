                        ...
                        jQuery('#saveTemplates').on("click", function() {
                            ...
                            AppConnector.request(params).then(
                                function(data) {
                                    ...
                                    jQuery('.text-wrapper').removeClass('hide');
                                    $('#hamburger').removeClass('show');
                                    jQuery('#writemsg').attr("disabled", true);
            ...
            if(data.result['iconactive'] == 1 ){
                if(data.result['whatsappicon'] != 0 ){
                    ...
                    if(data.result['isAdmin'] == 'on'){
                        var settingIcon = '<a class=""  href="index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList" style="display: inline-block;clear: none !important;'+rtlStyle+'padding: 0 4px;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/settings_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>';
                    }else{
                        var settingIcon = '';
                    }
