...
<div id="sendWhatsappbSmsContainer" class='modal-xs modal-dialog' style="background: #fbfbfb;">
    ...
    <div class = "modal-content">
		<table class="table table-borderless">
			...
			<tr>
				<td colspan="2" style="width: 19%;">
					<b>{vtranslate('MSGTEMPLATES', $MODULE)} : </b><select class="select2" name="wptemplatesid" id="wptemplatesid" style="width: 60%;">
						<option value="">{vtranslate('LBL_SELECT_WHATSAPPB_TEMPLATE',$MODULE)}</option>
			...
			<tr>
				<td colspan="2">
					<span><b>{vtranslate('LBL_NOTE', $MODULE)}</b> {vtranslate('LBL_WHATSAPPB_TEMP_NOTE', $MODULE)}</span>
				</td>
			</tr>
