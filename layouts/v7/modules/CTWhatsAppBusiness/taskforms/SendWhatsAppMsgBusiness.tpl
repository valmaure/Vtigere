        ...
        <div class="col-lg-9">
            ...
            <div class="row form-group col-lg-12">
                ...
                <div class="col-lg-10">
                    ...
                    &nbsp;&nbsp;
                    <a class="addTemplate btn btn-default" href="index.php?module=WhatsAppBusinessTemplates&view=Edit" target="_blank"><i class="fa fa-plus"></i></a>
                    &nbsp;&nbsp;
                    <a class="editTemplate btn btn-default hide" href="index.php?module=WhatsAppBusinessTemplates&view=Edit" target="_blank"><i class="fa fa-pencil"></i></a>
                ...
                AppConnector.request(params).then(
                    function(data) {
                        ...
                        if(wptemplatesid == ''){
                            ...
                            jQuery('.editTemplate').attr("href", "index.php?module=WhatsAppBusinessTemplates&view=Edit&record="+wptemplatesid);
                        }
                    }
                );
            });
