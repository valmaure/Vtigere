    ...
    <div class = "modal-content" style="overflow-y: auto;height: 500px;">
		...
		<table class="table table-borderless">
			...
			<tr>
				...
				<td>
					...
					<a class="addTemplate btn btn-default" href="index.php?module=WhatsAppBusinessTemplates&view=WhatsAppTemplateWidget&app=MARKETING" target="_blank"><i class="fa fa-plus"></i></a>
					<a class="editTemplate btn btn-default hide" href="index.php?module=WhatsAppBusinessTemplates&view=WhatsAppTemplateWidget&app=MARKETING" target="_blank"><i class="fa fa-pencil"></i></a>
				</td>
			</tr>
			<tr>
				<td colspan="2">
		...
		<div>
			<div class="modal-footer">
				<center>
					<button class="btn btn-success" id="sendmessagewb"><strong>{vtranslate('LBL_SEND', $MODULE)}</strong></button>
