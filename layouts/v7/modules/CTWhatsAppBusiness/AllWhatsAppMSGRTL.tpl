			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="dropdown">
						...
						<ul class="dropdown-menu whatsapMenus whatsappb" role="menu" aria-labelledby="dropdownMenu1" style="width:370px;">
							<li class="hide">
								<a href="#">
							...
							<li>
								<a href="index.php?module=WhatsAppBusinessTemplates&view=List">
									<p>{vtranslate('WhatsAppBusinessTemplates', 'WhatsAppBusinessTemplates')} <img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_templates.png" title="{vtranslate('WhatsAppBusinessTemplates', 'WhatsAppBusinessTemplates')}"/>
									</p>
								</a>
							</li>
							<li>
						...
						<div class="defaultText">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 padNone hide messageBlock">
								...
								<div class="conversationDiv yesRecordData">
									...
									<div>
										<div>
											<div class="firstMessageText hide" style="width: 100%;border: 1px solid lightgray;border-radius: 6px; height: 50px;">
												<span class="sendTemplates" id="sendFirstTemplatesMessage" style="float: left;margin-left: 12px;cursor: pointer;">
													&nbsp;&nbsp;&nbsp;&nbsp;<p title=""><span style="color:'#3366CC'">{vtranslate('LBL_CLICK_HERE', $MODULENAME)}</span> &nbsp;{vtranslate('SELECT_TEMPLATES', $MODULENAME)}</p>
												</span>
												&nbsp;&nbsp;
												<a href="https://kb.crmtiger.com/knowledge-base/how-to-use-whatsapp-business-integration-for-vtiger-7x/#whatsAppbusinesstemplate" target="_blank" title="Help"><img src="layouts/v7/modules/Settings/CTWhatsAppBusiness/images/help.png" style="width: 14px; padding-top: 16px;"></a>
											</div>
											<div class="ipt-div text-wrapper">
												<div class="ipt-msg-div searchForm conversation-compose text-wrapper whatsappb" data-emojiarea data-type="unicode" data-global-picker="false">
