                ...
                <div class="clearfix">
                    ...
                    <div class="btn-group pull-right" style="margin: 0px 10px 0px 0px;">
                      {if $ISADMIN eq 1}
                        ...
                        <button class="btn btn-success editButton" type="button" onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=whatsAppBotLicenseDetail'" style="margin: 0px 25px 0px 0px;">{vtranslate('LBL_LICENSE', $MODULENAME)}</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                      {/if}
                        ...
                        <a onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=whatsAppBotSetting'"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/settings_green.png" style="width: 24px;"></a>
                        &nbsp;&nbsp;
                        <a onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=DashBoard&mode=moduleDashBoard&analytics=1'"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_analytics.png" style="width: 24px;"></a>
                    </div>
                </div><hr>
