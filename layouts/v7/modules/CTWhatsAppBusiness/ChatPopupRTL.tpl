    ...
    <div class="modelContainer modal-dialog">
        ...
        <body>
            <div class="chat">
                ...
                <div class="whatsappb chat-container">
                    ...
                    <div id="call" class="user-bar">
                        ...
                        {else}
                            {if $COMMETNMODULE eq 1}
                                <div id="commentsdatewb" style="margin-left: 8px;">
                            ...
                            <div>
                                <div class="ipt-div text-wrapper">
                                    <div class="ipt-msg-div searchForm conversation-compose text-wrapper" data-emojiarea data-type="unicode" data-global-picker="false">
                                        ...
                                        <span aria-hidden="true" id="removeWhatsAppTemplate" class="fa fa-close closeReplybutton hide" style="position: absolute;right: 48px;cursor: pointer;"></span>
                                    ...
                                    <div class="icons-wrapper">
                                        <div class="ipt-div-num whatsappb">
                                            <span id="sendwhatsappmsg" class="send whatsappb msg_send_btnb" style="cursor: pointer;">
                                        ...
                                        <div class="ipt-ioc-div">
                                            ...
                                            <div id="selectTemplatesb" class="whatsAppTemplates" style="cursor: pointer;">
