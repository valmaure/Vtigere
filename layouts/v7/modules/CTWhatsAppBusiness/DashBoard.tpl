							...
							<ul class="dropdown-menu whatsapMenus" role="menu" aria-labelledby="dropdownMenu1">
								...
								<li class="">
									<a href="index.php?module=WhatsAppBusinessTemplates&view=List">
										<span id="refreshMessages" title="{vtranslate('WhatsAppBusinessTemplates', 'WhatsAppBusinessTemplates')}">
				        ...
				        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: 0px 0px 0px -3px;">
							<div class="waTabs" >
								<ul class="nav nav-tabs activetab" id="myTab">
									...
									<li class="nav-itemselectTab reportChart hide" data-selectTab="ChatbotStatistics">
								 		<a data-toggle="tab" class="nav-link">
